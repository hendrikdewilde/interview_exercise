    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_creation', models.DateTimeField(auto_now_add=True)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('from_number', models.CharField(blank=True, db_column='from_number', max_length=15, null=True, verbose_name='From number')),
                ('to_number', models.CharField(blank=True, db_column='to_number', max_length=15, null=True, verbose_name='To number')),
